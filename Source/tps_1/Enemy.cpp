...
void AEnemy::BeginPlay()
{
	...
	// setting the petrol point which was local to enemy to world space 
...
//, AActor* Shooter, AController* ShooterController)
{
	...
	if (ImpactParticles)
	{	
		/*true is the boolean for whether or not auto destroy the particle system,plays the impact particles at the location where the trace beam hits*/
...
void AEnemy::PlayHitMontage(FName Section, float PlayRate)
{
	if (bCanHitReact)
	{
		...
		bCanHitReact = false;
		//randomizing the delay timer in between the min and max value
